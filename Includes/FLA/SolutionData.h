...
class SolutionData {
 public:
  SolutionData() : best_solution_(nullptr), solution_tct_(0), number_hits_(0), differences_objective_function_(0), max_differences_objective_function_(0), min_differences_objective_function_(0) {}
  SolutionData(Solution* best_solution, int solution_tct, int number_hits, int differences_objective_function, int max_differences_objective_function, int min_differences_objective_function) :
